...
class ItemList(Resource):
    def get(self):
        return {'items': [item.json() for item in ItemModel.query.all()]} #- this is more pythoning ;)
        #return {'items': list(map(lambda x: x.json(), ItemModel.query.all()))} used also in other programming languages
